    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', django_enumfield.db.fields.EnumField(default=1, enum=core.models.Gender)),
        ...
        migrations.AddField(
            model_name='book',
            name='inventories',
            field=models.ManyToManyField(related_name='books', through='core.Book_Inventories', to='core.inventory'),
        ),
    ]
